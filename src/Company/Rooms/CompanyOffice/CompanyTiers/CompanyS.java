...
public class CompanyS extends Company
{
    public CompanyS(String companyName,String companyTier,int rent, 
    ...
    {
        super(companyName,"S",3500,levelUpPercent,progress,
        7,currentLevel,officeNumber,1200000,750,
