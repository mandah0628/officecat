...
public class CompanySS extends Company
{
    public CompanySS(String companyName,String companyTier,int rent, 
    ...
    {
        super(companyName,"SS",5500,levelUpPercent,progress,
        8,currentLevel,officeNumber,2400000,1250,
